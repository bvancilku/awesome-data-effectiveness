...
%\qrcode{betterposter-latex-template/img/qrcode}{betterposter-latex-template/img/smartphoneWhite}{
...
%\compactqrcode{betterposter-latex-template/img/qrcode}{
%\textbf{Take a picture} to
%\\download the full paper
%}
...
\includegraphics[width=\textwidth]{betterposter-latex-template/img/tikzexample1}
\end{center}
...
%% Institution logo
%\includegraphics[width=\textwidth]{betterposter-latex-template/img/logo}\\
...
\includegraphics[width=\textwidth]{betterposter-latex-template/img/tikzexample2}
\end{center}
...
\includegraphics[width=\textwidth]{betterposter-latex-template/img/ducklings}
\end{center}
}
\end{document}
